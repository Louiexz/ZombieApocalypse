...
class GameControls:
    ...
    def game_over(screen, settings, bullets, zombies, player, buttons):
        ...
        GameFuncts.new_text(screen, settings, [msg, 10*5], './assets/imagens/enemies/zombie-reaching.jpg')
    ...
    def run_game_loop(screen, settings, buttons, bullets, zombies, player):
        ...
        while settings.rodando:
            ...
            if som[0] == True: GameFuncts().play_sound(settings, "zombie/zombie-death")
            if som[1] == True: GameControls().game_over(screen, settings, bullets, zombies, player, buttons)
            elif som[1] == False: GameFuncts().play_sound(settings, "zombie/zombie-bite")
